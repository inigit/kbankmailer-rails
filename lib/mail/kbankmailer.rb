module Mail
  class Kbankmailer
    ...
    def initialize(values)
      ...
      self.settings = { :partner_url => ENV['KBANKMAILER_PARTNER_URL']}.merge(values)
    end
    ...
    def deliver!(mail)
      ...
      partner_url = settings.delete(:partner_url)
      client = ::Kbankmailer::HttpClient.new(partner_id, partner_secret, partner_url, settings)
